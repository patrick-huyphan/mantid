...
//    auto startTimes = std::vector<double>{0.2, 1.2, 2.4};
//    auto endTimes = std::vector<double>{0.5, 0.7, 0.9};
//    auto times = std::make_pair(startTimes, endTimes);
//    presenter->addNumSlicesEntry(0, 0, times);
//    presenter->addNumSlicesEntry(0, 1, times);
//    presenter->addNumSlicesEntry(0, 2, times);
//    presenter->addNumSlicesEntry(1, 0, times);
//    presenter->addNumSlicesEntry(1, 1, times);
//    presenter->addNumSlicesEntry(1, 2, times);
//    presenter->addNumGroupSlicesEntry(0, times);
//    presenter->addNumGroupSlicesEntry(1, times);
//
//    createSampleEventWS("13460_IvsQ_slice_0.2_to_1.2");
